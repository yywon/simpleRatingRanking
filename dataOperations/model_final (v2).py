...
class Profile:
    ...
    def __init__(self, n):
        ...
        self.max_hops = 0
        self.sci = SCI(1, 1)
        self.groundtruth = [0]*n
        self.max_rat = 0
        self.min_rat = 0

    # Read datafile and assign ranks
    # Change this as required
    def assign_rank(self, input_file, noise,i):
        ...
        for item in data:
            ...
            if tempEval.size == self.num_obj:
                ...
                ground_truth = [50 + i for i in range(32)]
...
def rating_and_ranking_model(file_name, num_obj, noise_level):
    ...
    #NOTE:
    #Changed R value to 10000000 and MU to .5
    R = 10000000
    L = prof.min_rat
    U = prof.max_rat
    mu = 0.5
    ...
    #NOTE:
    #Added this line to reverse Rating Vector
    rating = rating[::-1]
